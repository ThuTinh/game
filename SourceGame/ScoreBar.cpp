...
ScoreBar::ScoreBar()
{
	scoreBar = new GameTexture("assets/sprites/misc/scorebar/score_bar.png", D3DCOLOR_XRGB(10, 20, 60));
	miscSprite = SpriteManager::getInstance()->getSprite(SPRITE_INFO_MISC);
	timeGame.init(1000);

	ifstream ifs("assets/sprites/misc/scorebar/score_bar_item_location.txt");
